    ...
    <div className="bg-white rounded shadow w-full max-w-2xl p-16">
      ...
      <div className="grid grid-cols-2 gap-x-16 gap-y-12 text-sm sm:pb-8 mt-14">
        ...
        <div className="text-base">
          ...
          <div className="mt-1.5 border-b border-mainGray w-full">{dummyData.name}</div>
        </div>
        <div className="text-base">
          <div className="font-semibold text-gray-500">이메일</div>
          <div className="mt-1.5 border-b border-mainGray w-full">{dummyData.email}</div>
        </div>
        <div className="text-base">
        ...
        <div className="text-base">
          ...
          <div className="mt-1.5 border-b border-mainGray w-full">{dummyData.hireDate}</div>
        </div>
      </div>
