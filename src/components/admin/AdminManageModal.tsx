import { adminManageState } from '@/recoil/common/modal';
...
export default function AdminManageModal(props: IModalProps) {
  const [isAdminManageShow, setIsAdminManageShow] =
    useRecoilState(adminManageState);

  const modalRef = useRef<HTMLInputElement | null>(null);
  useEffect(() => {
    function handleOutside(e: Event) {
      if (modalRef.current && !modalRef.current.contains(e.target as Node)) {
        setIsAdminManageShow(false);
      }
    }
